...
class JoinViewBodyInBrands extends StatefulWidget {
  CompaniesNotJoined item;

  JoinViewBodyInBrands({Key? key, required this.item}) : super(key: key);

  @override
  State<JoinViewBodyInBrands> createState() => _JoinViewBodyInBrandsState();
}

class _JoinViewBodyInBrandsState extends State<JoinViewBodyInBrands> {
            ...
            Column(
              children: [
                ...
                Row(
                  children: [
                    Image.network(
                      widget.item.logo ?? 'https://w7.pngwing.com/pngs/539/973/png-transparent-kfc-fried-chicken-fast-food-restaurant-kfc-food-recipe-chicken-meat-thumbnail.png',
                      height: 64.h,
                      width: 64.w,
                    ),
                    SizedBox(width: 15.w),
                ...
                Theme(
                  data: Theme.of(context).copyWith(
                    ...
                    scrollbarTheme: ScrollbarThemeData(
                      isAlwaysShown: true,
                      trackBorderColor: MaterialStateProperty.all(AppColors.primaryColor),
                      // trackBorderWidth: 2.0,
                      thumbColor: MaterialStateProperty.all(AppColors.primaryColor),
                      trackColor:  MaterialStateProperty.all(AppColors.blackColor),
                      // mainAxisMargin: 200,
                    ),
                  ),
                  child: Scrollbar(
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  Text(
                                    BlocProvider.of<MyBrandsCubit>(context).termsAndConditions ?? 'Loading',
                                    style: GoogleFonts.darkerGrotesque(
                                      color: AppColors.black3Color,
                                      fontSize: 15.sp,
                                      fontWeight: FontWeight.w500,
...
class CustomContainerInJoinScreenInBtands extends StatelessWidget {
  final String image, text;

  const CustomContainerInJoinScreenInBtands(
